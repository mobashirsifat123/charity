...
function AdminBlogsContent() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await adminFetchJson(`/api/admin/resources/blogs/${id}`, {
        method: "DELETE",
      });
  ...
  const handleBulkDelete = async () => {
    ...
    if (!window.confirm(`Delete ${selectedIds.size} selected articles?`))
      return;
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(filteredAndSortedBlogs.length / itemsPerPage),
  );
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
          <div>
            <h2 className="fw-bold mb-1">
              <i className="fa-solid fa-pen-nib text-primary me-2"></i>Article
              Management
            </h2>
            <p className="text-muted mb-0">
              Create, edit, and organize all your community articles and
              insights.
            </p>
          </div>
          <Link
          ...
          <div className="card-body p-0">
            {loading ? (
              <div className="text-center py-5">
                <div
                  className="spinner-border text-primary shadow-sm"
              ...
              <div className="text-center py-5">
                <div className="bg-light rounded-circle d-inline-flex p-4 mb-3">
                  <i
                    className="fa-regular fa-folder-open text-muted"
                    style={{ fontSize: "3rem" }}
                  ></i>
                </div>
                <h5 className="fw-bold">No Articles Found</h5>
                <p className="text-muted">
                  Adjust your search or filters, or create a new article.
                </p>
              </div>
            ) : (
                    ...
                    <tr>
                      <th className="px-4 py-3" style={{ width: "50px" }}>
                        <input
                          ...
                          checked={
                            selectedIds.size > 0 &&
                            selectedIds.size === currentBlogs.length
                          }
                      ...
                      >
                        ...
                        <td className="py-3">
                          <div className="d-flex align-items-center gap-3">
                            {blog.image_url ? (
                              <div
                                className="bg-light rounded text-center overflow-hidden"
                              ...
                              <div
                                className="bg-light rounded text-center d-flex align-items-center justify-content-center"
                                style={{ width: "60px", height: "40px" }}
                              >
                        ...
                        <td className="py-3 text-center">
                          <button
                            ...
                            className={`btn btn-sm px-3 rounded-pill fw-medium border-0 bg-${blog.status === "published" ? "success" : "warning text-dark"} bg-opacity-10 text-${blog.status === "published" ? "success" : "warning text-dark"}`}
                          ...
                          >
                            {blog.status === "published" ? (
                              ...
                              <>
                                <i className="fa-solid fa-eye-slash me-1"></i>{" "}
                                Draft
                              </>
                            )}
                          </button>
                        ...
                        <td className="px-4 py-3 text-end">
                          <div className="d-flex gap-2 justify-content-end">
                            <Link
                              ...
                              className="btn btn-sm btn-light border-secondary text-primary"
                              title="Edit"
                            >
                            ...
                            <button
                              ...
                              className="btn btn-sm btn-light border-secondary text-danger"
                              title="Delete"
                            >
