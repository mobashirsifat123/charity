...
const BannerOne = () => {
    ...
    const systemPills = [
        { label: settings.hero_pill_1 || 'Quran Learning', tone: 'signal-chip__dot--green' },
        { label: settings.hero_pill_2 || 'Fatwas & Guidance', tone: '' },
        { label: settings.hero_pill_3 || 'Courses & Articles', tone: 'signal-chip__dot--soft' },
        { label: settings.hero_pill_4 || 'Charity With Impact', tone: 'signal-chip__dot--green' },
    ];
    const cards = [
    ...
    return (
        ...
        >
            {/* Decorative circles */}
            <div style={{ position: 'absolute', top: '10%', right: '8%', width: 320, height: 320, borderRadius: '50%', background: 'radial-gradient(circle, rgba(200,169,81,0.18) 0%, rgba(200,169,81,0) 68%)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', bottom: '5%', left: '4%', width: 260, height: 260, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0) 72%)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', inset: '12% 10% auto auto', width: 180, height: 180, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.08)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', inset: 'auto auto 14% 8%', width: 140, height: 140, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.06)', pointerEvents: 'none' }} />
                ...
                <div className="row align-items-center gy-5">
                    <div className="col-lg-6" data-aos="fade-right">
                        ...
                        <div className="d-flex flex-wrap gap-3 hero-cta-group">
                            ...
                            <Link href={settings.hero_secondary_cta_link || '/blog-grid'} className="btn btn-outline-light btn-lg px-5 rounded-pill btn-ripple">
                        ...
                        <div className="row mt-4 mt-lg-5 gy-3 hero-stats-row">
                            {stats.map(stat => (
                                <div key={stat.label} className="col-4">
                                    ...
                                    <small className="text-white" style={{ opacity: 0.64 }}>{stat.label}</small>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 d-none d-lg-block" data-aos="fade-left">
                        <div className="glass-surface workflow-panel p-4 p-xl-5">
                            <div className="d-flex align-items-center justify-content-between gap-3 mb-4">
                                <div>
                                    <div className="text-uppercase small fw-semibold mb-2" style={{ color: 'rgba(255,255,255,0.62)', letterSpacing: '0.12em' }}>
                                        Guided Experience
                                    </div>
                                    <h5 className="text-white fw-bold mb-0">
                                        A calmer digital workflow for learning, guidance, and giving
                                    </h5>
                                </div>
                                <span
                                    className="badge px-3 py-2 rounded-pill"
                                    style={{ background: 'rgba(255,255,255,0.08)', color: '#ecf7f1', border: '1px solid rgba(255,255,255,0.08)' }}
                                >
                                    Live Platform
                                </span>
                            </div>
                                        ...
                                        >
                                            <div className="d-flex align-items-center gap-3">
                                                <div
                                                    ...
                                                    style={{ width: 56, height: 56, background: `color-mix(in srgb, ${card.color} 16%, white)` }}
                                                >
                                                ...
                                                <div className="flex-grow-1">
                                                    <div className="d-flex justify-content-between align-items-center gap-3">
                                                        ...
                                                        <span className="small" style={{ color: card.color }}>Active</span>
                                                    </div>
                                                    <small style={{ color: 'rgba(255,255,255,0.74)' }}>{card.meta}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
