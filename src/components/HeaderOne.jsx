...
const HeaderOne = () => {
  ...
  const customNavLinks = parseJsonArraySetting(
    settings.nav_custom_links_json,
    [],
  ).filter(
    (item) =>
  ...
  const isArticleRoute =
    pathname === "/blog-grid" || pathname.startsWith("/blog-details/");
  const isEbookRoute =
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setScroll((previous) =>
        previous === shouldStick ? previous : shouldStick,
      );
    };
    ...
    if (desktopMenu && mobileMenuListRef.current) {
      ...
      const setupDropdownToggles = (container) => {
        ...
        dropdownLabels.forEach((label) => {
          ...
          cleanupFns.push(() =>
            label.removeEventListener("click", handleDropdownClick),
          );
        });
      };
  ...
  const accountInitial = (user?.name || user?.email || "U")
    .charAt(0)
    .toUpperCase();
  ...
  return (
    <>
                  ...
                  <div className="navbar__menu-wrapper">
                    <div className="navbar__menu d-none d-xl-block">
                      <ul className="navbar__list">
                        ...
                        <li
                          className={`navbar__item nav-fade ${
                            isArticleRoute ? "active" : ""
                          }`}
                        >
                          <Link href="/blog-grid">
                            {settings.nav_articles_label || "Articles"}
                          </Link>
                        </li>
                        <li
                          className={`navbar__item nav-fade ${
                        ...
                        >
                          <Link href="/ebooks">
                            {settings.nav_ebooks_label || "E-Books"}
                          </Link>
                        </li>
                        <li
                          className={`navbar__item nav-fade ${
                                  ...
                                  >
                                    <div className="account-menu__summary">
                                      ...
                                      <div className="account-menu__summary-content">
                                        <div className="account-menu__summary-name">
                                          {user.name || "IRWAA Member"}
                                        </div>
                                        <div className="account-menu__summary-email">
                                          {user.email}
                                        </div>
      ...
      <div
        className={`mobile-menu mobile-menu--primary d-block d-xl-none ${
