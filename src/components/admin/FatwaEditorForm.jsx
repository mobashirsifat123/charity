...
export default function FatwaEditorForm({ fatwaId = null }) {
  ...
  const fetchFatwa = async () => {
    try {
      const result = await adminFetchJson(
        `/api/admin/resources/fatwas/${fatwaId}`,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const resolvedSlug =
        formData.slug.trim() || slugify(formData.title || formData.question);
      const basePayload = {
      ...
      const optionalPayload = {
        ...
        author_name:
          formData.author_name || user?.name || user?.email || "IRWA Scholar",
      ...
      setMessage({
        type: "success",
        text: `Fatwa ${isEdit ? "updated" : "created"} successfully. All editable fatwa fields were saved permanently.`,
      });
      ...
      setMessage({
        type: "danger",
        text: error.message || "Failed to save fatwa.",
      });
    } finally {
      setSaving(false);
    }
      ...
      <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        <div>
          ...
          <p className="text-muted mb-0">
            Manage public rulings, scholarly metadata, publishing status, and
            homepage highlights.
          </p>
        </div>
        <button
        ...
        <div className="card-body p-4 p-md-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row g-4">
              ...
              <div className="col-12">
                <label className="form-label fw-bold">Public Summary</label>
                <textarea
                  className="form-control bg-light border-0"
                  name="summary"
                  rows="3"
                  ...
                  onChange={handleChange}
                  placeholder="Short preview shown in fatwa cards and search results."
                ></textarea>
              </div>
              <div className="col-md-4">
              ...
              <div className="col-md-4">
                ...
                <input
                  ...
                  value={formData.tags}
                  onChange={handleChange}
                  placeholder="zakat, fasting, marriage"
                />
              </div>
              ...
              <div className="col-md-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Scholar / Mufti / Contributor"
                />
              </div>
              <div className="col-md-4">
              ...
              >
                {saving ? (
                  ...
                  <>
                    ...
                    {isEdit ? "Save Changes" : "Publish Fatwa"}
                  </>
                )}
              </button>
            </div>
